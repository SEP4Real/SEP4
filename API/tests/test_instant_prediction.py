...
def test_instant_measurement_returns_stay_for_good_conditions(client):
...
def test_instant_measurement_returns_leave_for_bad_conditions(client):
...
def test_latest_instant_measurement_reads_database_snapshot(client, app):
...
def test_latest_instant_measurement_can_filter_by_session(client, app):
