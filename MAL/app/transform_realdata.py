...
# Input file generated by the /collect-data endpoint
REAL_HISTORY_FILE = BASE_DIR / "environment_history_realdata.csv"

# Output file formatted for model training
OUTPUT_FILE = BASE_DIR / "focus_dataset_realdata.csv"
...
def transform_real_data(input_file=REAL_HISTORY_FILE, output_file=OUTPUT_FILE):
    ...
    for session_id, session_data in df.groupby("session_id"):
        ...
        row = {
            ...
            # Mock a rating between 1 and 5 for testing model training
    ...
    print(f"✅ Created {len(dataset)} session rows in '{output_file.name}' with mocked ratings.")
